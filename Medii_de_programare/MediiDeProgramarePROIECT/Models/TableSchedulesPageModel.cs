...
namespace MediiDeProgramarePROIECT.Models
{
    public class TableSchedulesPageModel : PageModel
    {
        ...
        public void PopulateAssignedScheduleData(MediiDeProgramarePROIECTContext context, Table table)
        {
        ...
        public void UpdateTableSchedules(MediiDeProgramarePROIECTContext context, string[] selectedSchedules, Table tableToUpdate)
        {
